...
export default function GlobalError({
  ...
  return (
    <html lang="id">
      <body className="min-h-screen bg-slate-50 font-plus-jakarta flex flex-col items-center justify-center p-6 text-slate-900">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden text-center p-8">
          ...
          <p className="text-sm text-slate-600 mb-8 leading-relaxed">
            Maaf, sistem mengalami kendala teknis saat memproses permintaan Anda. Kami telah mencatat masalah ini.
          </p>
